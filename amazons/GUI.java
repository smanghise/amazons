...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Auto->White", this::autoWhite);
        addMenuButton("Auto->Black", this::autoBlack);
        addMenuButton("Manual->Black", this::manualBlack);
        addMenuButton("Manual->White", this::manualWhite);
